...
Role: Dedicated exclusively to processing the Machine Learning/AI Background Removal tasks.

⚙️ Environment Variables
To run this project locally, create a .env file in the root of your frontend directory:

# Primary backend for standard tools
VITE_API_BASE_URL=https://corex-tools.onrender.com

# Dedicated AI backend for background removal
VITE_BG_API_URL=https://kalai-dev-corex-tools.hf.space
