...
This project implements a smart microservice architecture, splitting lightweight tasks from heavy AI workloads.
...
* **Role:** Dedicated exclusively to AI-driven Background Removal.
